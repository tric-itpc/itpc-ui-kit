...
const getTransformOrigin = (arg: TransformOriginArg): string => {
  const startPosition: VERTICAL_POSITION_CALENDAR =
    arg.verticalPosition === VERTICAL_POSITION_CALENDAR.TOP
      ? VERTICAL_POSITION_CALENDAR.BOTTOM
      : VERTICAL_POSITION_CALENDAR.TOP
...
export const getCalculatePositionCalendar = (
  ...
  calendarWrapRef: React.RefObject<HTMLDivElement | HTMLUListElement>,

...
var DecimalField_1 = __webpack_require__(185);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DecimalFixed = void 0;
var decimal_js_light_1 = __webpack_require__(8351);
var DecimalFixed = /** @class */ (function () {
    function DecimalFixed(value, accuracy, empty) {
        ...
        this.fraction = fraction !== null && fraction !== void 0 ? fraction : null;
        this.empty = empty;
    ...
    DecimalFixed.prototype.equals = function (value) {
    ...
    DecimalFixed.prototype.generate = function () {
        return this.fraction === null
            ? this.empty && this.int === null
                ? ""
                : String(this.int)
            : "".concat(this.int, ".").concat(this.fraction);
    };
    DecimalFixed.prototype.greaterThan = function (value) {
        return new decimal_js_light_1.Decimal(this.generate()).greaterThan(value);
    };
    DecimalFixed.prototype.isEmpty = function () {
        return this.toString().length === 0;
    };
    DecimalFixed.prototype.isValid = function () {
        if (Number.isNaN(this.int)) {
            return false;
        }
        return !(this.fraction !== null && Number.isNaN(Number(this.fraction)));
    };
    DecimalFixed.prototype.isZero = function () {
        return new decimal_js_light_1.Decimal(this.generate()).isZero();
    };
    DecimalFixed.prototype.lessThan = function (value) {
        return new decimal_js_light_1.Decimal(this.generate()).lessThan(value);
    };
    DecimalFixed.prototype.minus = function (value) {
        return new decimal_js_light_1.Decimal(this.generate()).minus(value);
    };
    DecimalFixed.prototype.plus = function (value) {
        return new decimal_js_light_1.Decimal(this.generate()).plus(value);
    };
    DecimalFixed.prototype.toDecimal = function () {
        return new decimal_js_light_1.Decimal(this.generate());
    };
    DecimalFixed.prototype.toString = function () {
        return this.generate();
    };
    return DecimalFixed;
}());
exports.DecimalFixed = DecimalFixed;

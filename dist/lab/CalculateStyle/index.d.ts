...
export declare const getCalculatePosition: (refParent: React.RefObject<HTMLDivElement>, refChildren: React.RefObject<HTMLDivElement | HTMLUListElement>, position: PositionType, distanceBetweenElements?: number) => CSSProperties;
